...
void EventManager::Attach(Socket *socket) {
...
void EventManager::UpdateEvent(Socket *socket, unsigned int new_state, std::coroutine_handle<> coro_handle) {
  struct epoll_event ev {};
  ev.events = new_state;
